...
vec3 GetSHDiffuse(vec3 dir, uint level) {
    SH9 dirSH = ProjectOntoSH9(dir, level);
    dirSH.coefs[0] *= CosineA0;
    dirSH.coefs[1] *= CosineA1;
    dirSH.coefs[2] *= CosineA1;
    dirSH.coefs[3] *= CosineA1;
    if (level > 1) {
        dirSH.coefs[4] *= CosineA2;
        dirSH.coefs[5] *= CosineA2;
        dirSH.coefs[6] *= CosineA2;
        dirSH.coefs[7] *= CosineA2;
